...
function getRandomColors() {
    return `rgba(${getRandomColorNumber()}, ${getRandomColorNumber()},${getRandomColorNumber()}, 0.3)`;
}
        ...
        const tools = [
            ...
            },
            {
                ...
                icon: `
                    ...
                    `,
                description:
                    "Middleware to validate user input in the back end",
                color: "#9a00ff55",
            },
            {
            ...
            },
            {
                ...
                description:
                    "The storage service to upload and serve files from",
                color: "#75d6ff55",
            },
            {
            ...
            },
            {
                ...
                description:
                    "Postgres platform to host the database for this project.",
                color: "#18e5c955",
            },
        ];
